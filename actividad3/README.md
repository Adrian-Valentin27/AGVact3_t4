...
* **Crear Producto (POST):** ![Captura de POST](image-1.png)
* **Leer Productos (GET):** ![Captura de GET](image-2.png)
* **Actualizar Producto (PUT):** ![Captura de PUT](image-3.png)
* **Eliminar Producto (DELETE):** ![Captura de DELETE](image-4.png)
